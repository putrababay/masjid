...
// ../.wrangler/tmp/pages-2kEhas/functionsRoutes-0.860189159637774.mjs
var routes = [
  {
    routePath: "/api/nu",
    mountPath: "/api",
...
// ../../../bin/nodejs/node-v22/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../bin/nodejs/node-v22/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-sdSku6/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-sdSku6/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8952514375831948.mjs.map
